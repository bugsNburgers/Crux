...
const TEAM = [
  {
    ...
    linkedin: 'https://www.linkedin.com/in/suprateek-yawagal',
    initials: 'SY',
  },
  {
    id: 'ullas',
    ...
    linkedin: 'https://www.linkedin.com/in/ull0s-m/',
    initials: 'UM',
  },
];
      ...
      <div className="container">
        ...
        <div className={styles.statement}>
          <p className={`${styles.statText} mono`}>
            "When you work with Crux, you're talking directly to the people<br className={styles.desktopBr} />
            who will architect, build, and maintain your product."
          </p>
        </div>
      </div>
    </section>
