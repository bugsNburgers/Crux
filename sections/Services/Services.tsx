...
interface Service {
  ...
  accent: 'cyan' | 'lime' | 'magenta' | 'default'
  badge?: string
}
...
const SERVICES: Service[] = [
  ...
  {
    id: 'backend', icon: '⬡', title: 'Backend & DB',
  ...
  {
    id: 'support', icon: '⌘', title: '1:1 Support',
    desc: 'You talk to the people who built it. No ticket system. No outsourced support.',
    size: 'normal', accent: 'magenta',
  },
  {
    id: 'redis', icon: '⚡', title: 'Redis & Caching',
    ...
    <section className={`${styles.services} section`} id="services">
      <div className="container">
        ...
        <div className={styles.grid}>
          {SERVICES.map(svc => (
            <div key={svc.id} className={`${styles.card} ${styles[svc.size]} ${styles[`accent_${svc.accent}`]}`}>
