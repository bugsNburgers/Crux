  ...
  return (
    <Html lang="en">
      <Head>
        ...
        />
        <meta name="keywords" content="web development, software studio, full stack, React, Next.js, backend, UI/UX, Suprateek Yawagal, Ullas M" />
        {/* OG */}
        ...
        <meta name="twitter:description" content="We understand the problem. We build the solution. Nothing more." />
        {/* Favicon placeholder */}
